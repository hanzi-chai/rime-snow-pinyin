...
---@field start_session fun(self: self)
---@field finish_session fun(self: self)
---@field discard_session fun(self: self)
...
---@field update_entry fun(self: self, entry: DictEntry, commit: integer, prefix: string): boolean
---@field update_candidate fun(self: self, candidate: Candidate, commit: integer, prefix: string): boolean
...
---@field empty fun(self: self): boolean
---@field clear fun(self: self)
---@field pop_back fun(self: self): CommitRecord|nil
